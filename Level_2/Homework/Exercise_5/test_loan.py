...
# Section: 2.1: Classes
# Exercise: 5
# Description: This contains the test function for the Exercise 4, loan class
...
def main():
    ...
    print('Does the Loan.annualRate() function works? ', monthly_rate_math == monthly_rate_function)
    print()
    ...
    print('The monthly payment of this loan is: ', Loan.calcMonthlyPmt(loan1))
    ###############################################
    ...
    print('The outstanding balance of this loan at period ' + str(period) + ' months is: ' +
          str(Loan.calcBalance(loan1, period)))
