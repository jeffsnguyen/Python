...
def main():
    ...
    # Test 1.1
    # Scenario: Test the breakAbsolute stored lambda method
    print('Test 1.1: Test the breakAbsolute stored lambda method')
    print(breakAbsolute(1, 4, 1))
    print(breakAbsolute(1, 4, -1))
    print(breakAbsolute(1, 4, 100))
    print(breakAbsolute(1, 4, -100))
    print()

    # Test 1.2
    # Scenario: Test the breakRelative stored lambda method
    print('Test 1.2: Test the breakRelative stored lambda method')
    print(breakRelative(10, 5, 1))
    print(breakRelative(5, 10, 1))
    print(breakRelative(1, 2, 49))
    print(breakRelative(2, 1, 49))
    print()

    # Test 1.3
    # Scenario: Test the breakAbsRelative stored lambda method
    print('Test 1.3: Test the breakAbsRelative stored lambda method')
    print(breakAbsRelative(10, 5, 1))
    print(breakAbsRelative(5, 10, 1))
    print(breakAbsRelative(1, 2, 49))
    print(breakAbsRelative(2, 1, 49))
    print()
