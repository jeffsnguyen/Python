...
def main():
    ...
    # Scenario:
    #   This block will:
    #       1. Test the interestDueRecursive with no Memoize to see how long it takes.
    #       2. Test the intenseLoop with Timer and Memoize decorator
    #######################
    # Test 1
    testNum = 'Test 1'
    logging.info(f'{testNum}')
    print('1. Test the interestDueRecursive with no Memoize to see how long it takes.')
    ...
    time_start = time()
    print('Using non-cached version')
    print(f'interestDueRecursive at month 14th = {loan1.interestDueRecursive(14)}')
    time_end = time()
    ...
    testNum = 'Test 2'
    logging.info(f'{testNum}')
    print('2. Test the interestDueRecursive with Memoize to see how long it takes.')
    logging.info('2. Test the interestDueRecursive with Memoize to see how long it takes.')

    time_start = time()
    print('Using cached version')
    print(f'interestDueRecursiveMemoize at month 14th = {loan1.interestDueRecursiveMemoize(14)}')
    time_end = time()
    print(f'Took {time_end - time_start} to run.')
    # I'm not using Timer decorator because if I do it print the Timer everytime the recursion happens.
    print()
